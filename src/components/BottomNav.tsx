      ...
      <div className="mobile-nav-wrap mx-3 mb-2">
        ...
        >
          ...
          <path
            ...
            d="M16 18 H146 C153 18 156 35 160 55 C170 75 190 75 200 55 C204 35 207 18 214 18 H344 C352 18 358 24 358 32 V70 C358 76 354 80 348 80 H12 C6 80 2 76 2 70 V32 C2 24 8 18 16 18 Z"
          />
        </svg>
        ...
        <Link
          ...
          className="mobile-nav-fab-link group flex flex-col items-center justify-end gap-0.5 py-1.5"
        >
